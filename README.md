...
| 平台 | 文件 |
|---|---|
| Windows | `desktop_todo_Calendar-Setup-5.1.0.exe` |
| macOS (Apple Silicon) | `desktop_todo_Calendar-5.1.0-arm64.dmg` / `.zip` |
| macOS (Intel) | `desktop_todo_Calendar-5.1.0-x64.dmg` / `.zip` |
| Linux | `desktop_todo_Calendar-5.1.0-x64.AppImage`、`desktop_todo_Calendar_5.1.0_amd64.deb` |
| 源码 | `desktop_todo_Calendar-Source-5.1.0.zip` |
