...
| 平台 | 文件 |
|---|---|
| Windows | `desktop_todo_Calendar-Setup-4.5.0.exe` |
| macOS (Apple Silicon) | `desktop_todo_Calendar-4.5.0-arm64.dmg` / `.zip` |
| macOS (Intel) | `desktop_todo_Calendar-4.5.0-x64.dmg` / `.zip` |
| Linux | `desktop_todo_Calendar-4.5.0-x64.AppImage`、`desktop_todo_Calendar_4.5.0_amd64.deb` |
| 源码 | `desktop_todo_Calendar-Source-4.5.0.zip` |
