...
| 平台 | 文件 |
|---|---|
| Windows | `desktop_todo_Calendar-Setup-4.4.2.exe` |
| macOS (Apple Silicon) | `desktop_todo_Calendar-4.4.2-arm64.dmg` / `.zip` |
| macOS (Intel) | `desktop_todo_Calendar-4.4.2-x64.dmg` / `.zip` |
| Linux | `desktop_todo_Calendar-4.4.2-x64.AppImage`、`desktop_todo_Calendar_4.4.2_amd64.deb` |
| 源码 | `desktop_todo_Calendar-Source-4.4.2.zip` |
